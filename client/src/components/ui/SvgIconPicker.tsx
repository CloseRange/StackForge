    ...
    <div className="space-y-2">
      {allowNone ? (
        <button
          ...
          className={`btn-motion btn-shimmer flex w-full items-center gap-2 rounded-xl border px-3 py-2 text-left text-sm transition ${
            !selectedIcon
        ...
        {PROJECT_ICON_OPTIONS.map((icon) => {
          ...
          return (
            <button
              ...
              className={`btn-motion btn-shimmer flex aspect-square items-center justify-center rounded-lg border transition ${
                isSelected
